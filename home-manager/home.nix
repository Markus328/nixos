{ pkgs, t64gram, ... }:
{
  ...
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-39ab8f92-aafa-4230-8580-3e22392ed75b" = [ ];
      "ActivityManager"."switch-to-activity-7ef84118-7dff-4650-b792-6f54ee8ed24d" = [ ];
      ...
      "kwin"."Switch to Desktop 1" = ["Ctrl+1" "Ctrl+F1"];
      ...
      "kwin"."Switch to Desktop 2" = ["Ctrl+2" "Ctrl+F2"];
      "kwin"."Switch to Desktop 20" = [ ];
      "kwin"."Switch to Desktop 3" = ["Ctrl+3" "Ctrl+F3"];
      "kwin"."Switch to Desktop 4" = ["Ctrl+F4" "Ctrl+4"];
      "kwin"."Switch to Desktop 5" = [ ];
      "kwin"."Switch to Desktop 6" = "Ctrl+5";
    ...
    files = {
      ...
      "baloofilerc"."General"."folders\x5b$e\x5d" = "$HOME/,/userdata/@workspace/";
      "dolphinrc"."KFileDialog Settings"."Places Icons Auto-resize" = false;
      "dolphinrc"."KFileDialog Settings"."Places Icons Static Size" = 22;
      "kactivitymanagerdrc"."activities"."7ef84118-7dff-4650-b792-6f54ee8ed24d" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "7ef84118-7dff-4650-b792-6f54ee8ed24d";
      "kcminputrc"."Keyboard"."RepeatDelay" = 305;
      "kcminputrc"."Keyboard"."RepeatRate" = 30.71;
      ...
      "khotkeysrc"."Data_2_1Triggers0"."Uuid" = "{3c915e85-2df5-4dd2-be58-f42fedeab12e}";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Uuid" = "{cda2108e-b100-4173-a1cf-e7ee3739e223}";
      ...
      "khotkeysrc"."Data_2_3Triggers0"."Uuid" = "{f5c1b579-f4c1-47d4-a2a0-27dc88d740a3}";
      ...
      "khotkeysrc"."Data_2_4Triggers0"."Uuid" = "{40a399bf-dbe7-4861-8468-11ed69a4da3d}";
      ...
      "khotkeysrc"."Data_2_5Triggers0"."Uuid" = "{db35703a-6085-4d06-934b-c639e9c7cd01}";
      ...
      "khotkeysrc"."Data_2_6Triggers0"."Uuid" = "{4e44e788-d74a-4fa7-bb7b-7a1985ef37c1}";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Uuid" = "{74c22b22-be1b-4def-80ee-4d3e5fbbd320}";
      ...
      "systemsettingsrc"."Open-with settings"."History" = "tele,fire,kee,next,nex,/home/markus/.config/util/mpv.sh,64gr";
    };
  };
}
